...
<script type="text/javascript">
	...
	function callBackGroup(data){
		...
		for(var i=0;i<data.length;i++){
		 ...
		 var groupId='${member.group.groupId}';
		 $("#group").find("option[value="+groupId+"]").attr("selected",true);
		 selectRole(groupId);
	}
  ...
  function callBackRole(data){
		...
		var roleId ='${member.role.roleId}';
		$("#role").find("option[value="+roleId+"]").attr("selected",true);
	}
	...
	<div class="form-container">
		<form id="updateForm" name="updateForm" method="post"
			...
			<fieldset>
				...
				<div>
					<label for="type"> 用户类型：<em>*</em></label> 
					<select name="type">
